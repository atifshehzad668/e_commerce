    ...
    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel"
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <picture>
                    <source media="(max-width: 799px)"
                        srcset="{{ asset('front-assets/images/images/carousel-1-m.jpg') }}" />
            ...
            <div class="carousel-item">
                ...
                <picture>
                    <source media="(max-width: 799px)"
                        srcset="{{ asset('front-assets/images/images/carousel-2-m.jpg') }}" />
            ...
            <div class="carousel-item">
                ...
                <picture>
                    <source media="(max-width: 799px)"
                        srcset="{{ asset('front-assets/images/images/carousel-3-m.jpg') }}" />
                ...
                @foreach ($latest_products as $latest_product)
                    <div class="col-md-3">
                        <div class="card product-card">
                            <div class="product-image position-relative">
                                <a href="" class="product-img">
                                    @if ($latest_product->getMedia('images')->isNotEmpty())
                                        <img style="height: 200px; width: 100%"
                                            src="{{ $latest_product->getFirstMediaUrl('images') }}"
                            ...
                            <div class="card-body text-center mt-3">
                                <a class="h6 link" href="product.php">{{ $latest_product->name }}</a>
                                <div class="price mt-2">

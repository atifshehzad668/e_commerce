...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form id="CategoryForm" enctype="multipart/form-data" name="CategoryForm">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" value="{{ $category->slug }}" readonly
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="image" class="dropzone dz-clickable">
                                        ...
                                        <br>Drop File Here Or Upload <br>
                                    </div>

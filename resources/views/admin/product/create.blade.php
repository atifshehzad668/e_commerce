...
@section('content')
    ...
    <section class="content">
        <!-- Default box -->
        <form action="" method="post" name="ProductForm" enctype="multipart/form-data" id="ProductForm">
...
@section('customjs')
    ...
    //         <img src="${response.ImagePath}" style="width: 300px; height: 200px; border-radius: 10px; object-fit: cover;" class="card-img-top" alt="">
    //         <div class="card-body">
